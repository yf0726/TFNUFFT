...
def L1TVOLS(nufft, y, maxiter, rho):  # main function of solver
    ...
    uker = uker - LMBD * create_laplacian_kernel(nufft)
    #     print('uker.shape', uker.shape)
...
def solve(nufft, y, solver=None, *args, **kwargs):
    ...
    if 'dc' == solver:
        ...
        #                 print('spH ')
        A = scipy.sparse.linalg.LinearOperator((nufft.st['M'] * nufft.batch, nufft.Kdprod * nufft.batch), matvec=sp,
                                               rmatvec=spH, )
